        ...
        <footer className="bg-white">
            <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
                <div className="text-center flex flex-col items-center justify-center">
                    <h2 className="text-3xl font-extrabold bg-gradient-to-r from-[#05D3AE] via-[#2E1EE4] to-[#990077]  text-transparent bg-clip-text sm:text-5xl h-20">Create Your Own Blog Page</h2>
                    ...
                    <Link href="/login" className="flex max-w-sm rounded-3xl bg-gradient-to-tr from-[#05D3AE] via-[#2E1EE4] to-[#990077] p-0.5 shadow-lg mt-10">
                        <button className="flex-1 font-bold text-xl bg-white px-6 py-3 rounded-3xl">Register</button>
                    </Link>
                </div>

                <div
                    className="mt-8 border-t border-gray-100 pt-8 sm:flex sm:items-center sm:justify-between lg:mt-24"
                >
